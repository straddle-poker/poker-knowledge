...
- **Overbet on multiple-gut-shot boards**: ~105% pot. Protection from draws
 + overcards. Removes hands from villain's check-call range, creating better turn value spots.
...
## Rules Q&A
- Q: W
hat boards does the covered BTN range bet?
...
- "overbet sizing... not a thing on two-tone boards, and it's no
t a thing on open-ended straight draw boards"
