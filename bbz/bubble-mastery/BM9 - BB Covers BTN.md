...
- **Sizing down on turns/rivers**:
 Covered stack uses smaller sizings to reduce risk.
...
- Q: What changes about BB's leading frequency when BB covers BTN?
  ...
  Correct: 0
  Explanation: BB's preflop range connects with low/pair boards; BTN's doesn't. BB leads at a much higher frequency than ChipEV — often pu
re.
